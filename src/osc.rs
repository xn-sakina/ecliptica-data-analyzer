...
mod tests {
    ...
    fn renders_supported_variables_and_preserves_newlines() {
        let snapshot = GameSnapshot {
            latest_dps: 20_000,
            average_dps: 45,
            round_effective_dps: 54,
            round_burst_10s_dps: Some(78),
    ...
    fn default_template_is_empty_without_data_and_compact_with_data() {
        ...
        let snapshot = GameSnapshot {
            latest_dps: 0,
            round_effective_dps: 45,
            round_burst_10s_dps: Some(72),
